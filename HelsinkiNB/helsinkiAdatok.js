...
var sportAdatok = ObjektumFeltolto(helsinki);
function PontszerzoHelyezesekSzama(vizsgaltTomb) {
    return vizsgaltTomb.length;
}
function HelyezesekSzamaKiir(kiirandoErtek) {
...
function OsszPontszam(vizsgaltTomb) {
    var osszeg = 0;
    for (var i = 0; i < vizsgaltTomb.length; i++) {
        if (vizsgaltTomb[i].helyezes == 1) {
            osszeg + 7;
